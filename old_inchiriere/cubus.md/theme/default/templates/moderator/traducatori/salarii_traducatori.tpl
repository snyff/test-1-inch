                                ...
                                <div class="tabbertab">
									        ...
									        <h2>Salarii traducatori</h2>
								                            ...
								                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td valign="top">
											                            <font class="black_text_content_bold"><b><a href="?L=moderator.traducatori.salarii_traducatori&idtrad={id.trad}">Fisiere neachitate</a> | <a href="?L=moderator.traducatori.salarii_traducatori&idtrad={id.trad}&list_files=all">Toate</a></b></font>
 										                            </td>
                                                                </tr>
                                                            </table>
											
											
											<form method="post" action="?L=moderator.traducatori.salarii_traducatori&idtrad={id.trad}">
											 ...
											 <input type="submit" value="Achitat !!!" style="position:fixed; top:200px; width:150px; right:5px;" class="button_css" />
