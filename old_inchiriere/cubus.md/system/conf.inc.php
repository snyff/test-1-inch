...
// MYSQL-RELATED CONFIGURATIONS ///////////////////////////////////////////////////////
	...
	$CONF["MYSQL_DATABASE_TABLES_PREFIX"] =					"oemp_";
	$CONF["MYSQL_DATABASE_USERNAME"] =						"root";
	$CONF["MYSQL_DATABASE_PASSWORD"] =						"mda";
	$CONF["MYSQL_DATABASE_HOSTNAME"] = 						"localhost";
	$CONF["MYSQL_DATABASE_DATABASENAME"] =					"cubus";
...
// LOCALES SETTINGS ///////////////////////////////////////////////////////////////////
	...
	$CONF["LOCALE_SITE_LANGUAGES"] = "ro,ru,en";
...
// UPLOADS, FILES AND PICTURES ////////////////////////////////////////////////////////
	...
	$CONF["PICTURES_ALLOWED_EXTENTIONS"] = "gif,jpg,jpeg,png,bmp,doc,txt,xls,rtf,pdf,ppt,docx,odt";
	$CONF["FILES_COUNTED_EXTENTIONS"] = "doc,txt,rtf,docx,odt";
	...
	$CONF["ATTACHMENT_ALLOWED_EXTENTIONS"] = "txt,doc,zip,rar,gif,jpg,jpeg,png,pdf,rtf,bmp,ppt,docx,odt";
	$CONF["MAX_UPLOAD_FILE_SIZE"] = "52428800";
...
// Account Payment Images /////////////////////////////////////////////////////////////////
	...
	$CONF["AP_IMG_SMALL_COMPANY_LOGO"] =	    		    'image005.jpg';
 	...
 	$CONF["files_folder"] = 								"sys/";
	
	$CONF["new_files"] =	 				    	        'pictures';
	$CONF["edited_files"] =	 				    	        'editate';
	$CONF["translated_files"] =				    	        'translation';
	$CONF["translators_tests"] =			    	        'tranlsatorsTests';
	$CONF["account_payment"] =				    	        'accountsPayment';
	$CONF["translators_cv"] =				    	        'translatorsCv';

	$CONF["translate_min_file"] =			    	        45;
...
// Mail Alert ////////////////////////////////////////////////////////////////////////////////
	...
	$CONF["EMPROYEES_MAIL_LIST"] =                  	    'guzun.vasile@gmail.com,andrei.spinu@gmail.com';
...
// Company Contact Information ////////////////////////////////////////////////////////////////////////////////
	...
	$CONF["COMPANY_MOBILE_NUMBERS"] =          			    '+373 68640001';
	$CONF["COMPANY_EMAIL"] =  	                   			'info@cubus.md';
	$CONF["COMPANY_CD"] =  	                   				'2224101763';
	$CONF["COMPANY_FISCAL_CODE"] =             				'1007600060826';  
	$CONF["COMPANY_BANK"] = 	            				'Banca Comerciala Rom�na Chisinau S.A.,';  
	$CONF["COMPANY_BANK_CODE"] =            				'RNCBMD2X';    
	$CONF["COMPANY_CEO_NAME"] = 	           				'Mihai Stipanov';  

// Default languages dislay ////////////////////////////////////////////////////////////////////////////////
	// DEFAULT_FROM_TO_LANGUAGE default is 0
	$CONF["DEFAULT_FROM_TO_LANGUAGE"] = 1;
