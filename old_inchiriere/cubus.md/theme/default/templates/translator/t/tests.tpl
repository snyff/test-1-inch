		...
		<div id="store" class="left-column">
			<h3>
				<div style="float:right;font-size:11px;">
					<a href="{siteURL}/?L=translator.t.tests">[Reincarca Pagina {3005}]</a>  
				</div>
				[Teste Traducator {3000}]
			</h3>
			<div class="big-box">
										...
										<table id="{unic_id}" style="display:none; width:95%;" class="license" cellspacing="0" cellpadding="0" border="0">
											<tr>
											   ...
											   <td style="padding-left:5px;" valign="top">
													...
													<form method="post" action="?L=translator.t.insertFile&chromeless=1" onsubmit="return checkform()" enctype="multipart/form-data">
											   ...
											   <td>
												   	<p>
														<a class="buttons download" href="?L=download.file&chromeless=1&path=translators_tests&file={file.originalFile}&filename={file.originalName}">[Descarca {3025}]</a>
													</p>
