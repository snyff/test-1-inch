...
<ZONE islogin login>
	<div id="bd">
		<div id="store" class="left-column">
			<h3>
				<div style="float:right;font-size:11px;">
					<a href="{siteURL}/?L=translator.e.archive">[Reincarca Pagina {3005}]</a>  
				</div>
				[Arhiva editari {3007}]
			</h3>
			<div class="big-box">
				<div class="big-box-inner">
 					<ZONE tabber active>							
								...
								<ZONE archiveFiles enabled>							
									...
									<LOOP archiveFilesList>
										<h4>
											...
											<input readonly="readonly" value="{file.originalName}" size="15" style="border:0; font-weight:bold; color:#333333;" /> <span style="font-weight:normal;">( {file.translateFrom} -> {file.translateTo} ) : {file.type}</span></font>
											<div style="float:right; margin-top:-17px; font-weight:normal;">[Pretul {3027}] {file.e.price} | {file.data} {file.e.paySalary}</div>
										</h4>
						...
						<a href="?L=translator.e.archive&action=print&chromeless=1" target="_blank">Versiunea Print</a>
 	...
 	<OBJ eSalaryPay>	
		&nbsp;<A href="?L=translator.e.payment&paymentStatus={file.paymentStatus}&unic_id={file.unic_id}&chromeless=1"><img src="{imgFiles}/pay_add.gif" align="absmiddle" /></A>
	</OBJ eSalaryPay>		
	
 	<OBJ eSalaryPaid>	
		&nbsp;<A href="?L=translator.e.payment&paymentStatus={file.paymentStatus}&unic_id={file.unic_id}&chromeless=1"><img src="{imgFiles}/pay_delete.gif" align="absmiddle" /></A>
	</OBJ eSalaryPaid>		
