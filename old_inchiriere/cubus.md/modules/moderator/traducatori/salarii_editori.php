...
///////////////////////////////////////////////////////////////////////////////////////
	...
	if ( me('id') && $_GET['chromeless'] == 0 && isset($_GET['achitat']) && $_GET['achitat'] != '' ) {	
		...
		*/
		...
		_fnc("reload", 0, "?L=moderator.salarii_traducatori&list_files=all&idtrad=".$_GET['idtrad']."&as=31");
		die();
	...
	*/
	if ( me("id")!='' && count($_POST['check']) > 0 ) {
		...
		_fnc("reload", 0, "?L=moderator.salarii_traducatori&idtrad=".$_GET['idtrad']."&as=1");
		die();
	}
    		...
    		*/
			...
			while ($listaFisiereTrad = myF($listaFisiere)) {
				 ...
				 if ( $listaFisiereTrad['trad_achitat'] == 0) {
				     ...
				     $caz_achitat = "<td width=40>
									    <a href=?L=moderator.salarii_traducatori&idtrad=".$_GET['idtrad']."&achitat=".$listaFisiereTrad['id']."><img src=\"theme/default/images/icons/alert/green_alert.gif\" /></a>
									</td>";				 
				 }
