function deleteFileConfirmation(unic_id) {
	var answer = confirm("Sunteti sigur ca doriti sa stergeti acest fisier?")
	if (answer){
		window.location = "?L=moderator.files.deleteFile&chromeless=1&delete_file="+unic_id;
	}
}

function checkform() {
	return confirm('Sunteti sigur ca datele introduse sunt corecte?');
}
