...
class GetAnnStatsBlock extends Block{
	function buildContent() {
		...
		$infoText = '<div class="textBold textSize19 textGreen textCenter marginBottom5">'.$infoText.'</div>';
		$len = $dayFinal;
		$str = '['.$str.']';
		$html .= '
			...
			<div class="statsButsDiv">
				<input type="button" value="'.translate(137, LANG, 'Curata').'" id="clear" class="but">
			</div>
