			...
			<div class="big-box">
				<div class="big-box-inner">
					...
					<ZONE testList enabled>
						...
						<OBJ fileNone>
							<nobr>
								<form enctype="multipart/form-data" action="?L=moderator.translators.tInsertTestFile&chromeless=1" method="post"> 
						...
						<OBJ fileIs>
							{file.name} <a href="?L=moderator.translators.tDeleteTestFile&f={file.id}&chromeless=1"><img src="theme/default/components/images/delete3.png"></a>
						</OBJ fileIs>		
